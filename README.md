...
100% of the code in this repo has been generated by codex-cli with
[codex-harness](https://github.com/mbhatia/codex-harness) multiagent stack.
Model used was GPT-5.6-sol-high for most of the development. With initial development happening with
Codex mobile and then shifted to laptop development with computer-use for visual verification.
